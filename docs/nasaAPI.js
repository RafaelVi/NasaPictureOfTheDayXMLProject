...
buttonDiaEspecifico.addEventListener("click",function(){
    ...
    let data = nasa.verificaData(date.value,"");
...
buttonDiaPosterior.addEventListener("click",function(){
    ...
    let novoDia = nasa.verificaData(diaAtual,"+");//verifico o dia e retorno o dia posterior
...
buttonDiaAnterior.addEventListener("click",function(){
    ...
    let novoDia = nasa.verificaData(diaAtual,"-");//verifico o dia e retorno o dia anterior
    document.getElementById("divContainer").remove();
